...
${BASE}/image_verify.sh --http-port 4321 --source tests/overrides/cors/expectations-unfiltered-php --env-file tests/overrides/cors/envfile-unfiltered --http-port 4321 --http-path index.php --user "${IMAGE_USER}" --cors-origin-host www.foobar.com ${IMAGE_NAME}:${IMAGE_TAG}
${BASE}/image_verify.sh --source tests/overrides/cors/expectations-filtered-png --env-file tests/overrides/cors/envfile-filtered --http-port 4321 --http-path public/image.png --user "${IMAGE_USER}" --cors-origin-host www.example.com ${IMAGE_NAME}:${IMAGE_TAG}
${BASE}/image_verify.sh --source tests/overrides/cors/expectations-unfiltered-png --env-file tests/overrides/cors/envfile-unfiltered --http-port 4321 --http-path public/image.png --user "${IMAGE_USER}" --cors-origin-host www.foobar.com ${IMAGE_NAME}:${IMAGE_TAG}
...
--http-port 4321 --http-path index.php --user "${IMAGE_USER}" --cors-origin-host www.foobar.com ${IMAGE_NAME}:${IMAGE_TAG} || (EXIT_CODE=$?; if [ ${EXIT_CODE} -eq 5 ]; then echo "\e[32mTests are failed, this is what we want to test\e[39m"; exit 0; elif [ ${EXIT_CODE} -eq 0 ]; then exit 99; else exit ${EXIT_CODE}; fi)

${BASE}/image_verify.sh \
--source tests/overrides/cors/expectations-filtered-different-domain-png \
--env-file tests/overrides/cors/envfile-filtered-different-domain \
--http-port 4321 --http-path public/image.png --user "${IMAGE_USER}" --cors-origin-host www.foobar.com ${IMAGE_NAME}:${IMAGE_TAG} || (EXIT_CODE=$?; if [ ${EXIT_CODE} -eq 5 ]; then echo "\e[32mTests are failed, this is what we want to test\e[39m"; exit 0; elif [ ${EXIT_CODE} -eq 0 ]; then exit 99; else exit ${EXIT_CODE}; fi)

# From-to-www redirect
print_title "from-to-www redirect tests"
${BASE}/image_verify.sh --source tests/overrides/from-to-www/expectations --env-file tests/overrides/from-to-www/envfile --http-port 4321 --user "${IMAGE_USER}" --req-header-host domain1.com ${IMAGE_NAME}:${IMAGE_TAG}
...
${BASE}/image_verify.sh --source tests/overrides/from-to-www/expectations-related-domains --env-file tests/overrides/from-to-www/envfile-related-domains --http-port 4321 --user "${IMAGE_USER}" --req-header-host domain1.com ${IMAGE_NAME}:${IMAGE_TAG}
...
${BASE}/image_verify.sh --source tests/overrides/from-to-www/expectations-related-domains-domain2 --env-file tests/overrides/from-to-www/envfile-related-domains --http-port 4321 --user "${IMAGE_USER}" --req-header-host www.domain2.it ${IMAGE_NAME}:${IMAGE_TAG}
...
${BASE}/image_verify.sh --source tests/overrides/from-to-www/expectations-related-domains-domain3 --env-file tests/overrides/from-to-www/envfile-related-domains --http-port 4321 --user "${IMAGE_USER}" --req-header-host domain3.eu ${IMAGE_NAME}:${IMAGE_TAG}

# From-to-www redirect for 3rd/4th level
print_title "from-to-www redirect tests for 3rd/4th level"
${BASE}/image_verify.sh --source tests/overrides/from-to-www/expectations-related-domains-domain4 --env-file tests/overrides/from-to-www/envfile-related-domains --http-port 4321 --user "${IMAGE_USER}" --req-header-host www.api.domain4.net ${IMAGE_NAME}:${IMAGE_TAG}
